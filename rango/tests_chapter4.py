...
class Chapter4StaticMediaTests(TestCase):
    ...
    def test_does_static_directory_exist(self):
        ...
        does_images_static_dir_exist = os.path.isdir(os.path.join(self.static_dir,
                                                                  '../../../Downloads/Rango Tests/Images'))
        does_rango_jpg_exist = os.path.isfile(os.path.join(self.static_dir, '../../../Downloads/Rango Tests/Images', 'rango.jpg'))
